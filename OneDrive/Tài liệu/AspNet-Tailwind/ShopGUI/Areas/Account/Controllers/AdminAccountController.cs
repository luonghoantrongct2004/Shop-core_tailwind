...
namespace Shop.Web.Areas.Admin.Controllers
{
    ...
    public class AdminAccountController : Controller
    {
        ...
        public AdminAccountController(UserManager<ShopUser> userManager, SignInManager<ShopUser> signInManager, ILogger<AdminAccountController> logger, SendMailService emailSender)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(model.Email,
                      ...
                      @$"Bạn đã đăng ký tài khoản trên Shop, hãy <a href='{callbackUrl}'>bấm vào đây</a> để kích hoạt tài khoản.");
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                _logger.LogInformation(5, "Người dùng đăng nhập với {Name} cung cấp.", info.LoginProvider);
                return LocalRedirect(returnUrl);
            }
            if (result.RequiresTwoFactor)
            {
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ShopUser externalEmailUser = null;
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _signInManager.SignInAsync(user, isPersistent: false);
                        _logger.LogInformation(6, "Người dùng tạo tài khoản mới với {Name} cung cấp.", info.LoginProvider);
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                return RedirectToAction(nameof(AdminAccountController.ResetPasswordConfirmation), "Account");
            }
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            var message = "Mã bảo mật của bạn: " + code;
        ...
        public async Task<IActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            if (result.IsLockedOut)
            {
                _logger.LogWarning(7, "Tài khoản đã bị khóa.");
                return View("Lockout");
            }
            else
            {
                ModelState.AddModelError(string.Empty, "Không đúng code.");
                return View(model);
            }
        }
